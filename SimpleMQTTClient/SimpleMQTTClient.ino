...
EspMQTTClient client(
    "PruebasHW",
    "Smt2017*",
    "margarita-bolivar-col.cloud.shiftr.io", // MQTT Broker server ip
    "margarita-bolivar-col",                 // Can be omitted if not needed
    "zVyfZZuNCNluwelw",                      // Can be omitted if not needed
    "esp32_device_2",                        // Client name that uniquely identify your device
...
void onConnectionEstablished()
{
  ...
  client.subscribe(myTopic.c_str(), [](const String &topic, const String &payload)
